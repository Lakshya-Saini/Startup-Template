<?php
    ...
    {
        mysqli_query($connect, "DELETE FROM users_table WHERE email = '$email'");
    ...
    if(isset($_POST['save']))
    {
        ...
        $sql = mysqli_query($connect, "SELECT password FROM users_table WHERE email='$email'");
        if($sql->num_rows > 0)
        {
            ...
            { 
                ...
                else
                {
                    ...
                    mysqli_query($connect, "UPDATE users_table SET password = '$hashedpassword' WHERE email='$email'");
