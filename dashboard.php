<?php
   ...
   $sql = "SELECT * FROM uploads WHERE email='$email'";
   $result = mysqli_query($connect, $sql);
   $queryResults = mysqli_num_rows($result);   

   $sql1 = "SELECT * FROM uploads WHERE status='Developing' AND email='$email' ";
...
<body>
   ...
   <section id="sections" class="py-4 mb-4 bg-faded">
      <div class="container">
         <div class="row">
            <div class="col-md-4">
               <a href="addProject.php" class="btn btn-block shadow-none" id="add">
   ...
   <section id="projects">
      <div class="container mb-3">
         <div class="row">
            ...
            <div class="col-md-6">
               <div class="card mb-3 text-center text-white mt-3" id="total">
                  <div class="card-block py-2">
