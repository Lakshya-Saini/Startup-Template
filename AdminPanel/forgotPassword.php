      ...
      else
      {
          ...
          if($sql->num_rows > 0)
          {
              ...
              $mail->Body = "
                  ...
                  <a href='http://localhost/Startup%20Redesign/AdminPanel/resetPassword.php?email=$email&token=$token'>Click here to Reset</a>
              ";

              mysqli_query($connect, "UPDATE user SET token='$token' WHERE email='$email'");
